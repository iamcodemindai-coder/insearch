...
def process(data):
    ...
    # EMPTY ISSUE SUMMARY
    # --------------------------------------------------------
    # If pcm_issue_summary is empty/null/whitespace:
    # - Do NOT call LLM
    # - Score every notification = 0
    # - LLM time = 0
    # --------------------------------------------------------
    ...
    if not issue_summary:
        ...
        print(
            "COMMENT: pcm_issue_summary is empty. "
            "All scores will be 0. LLM call skipped."
        )
...
def run_batch(
    ...
    for file_index, input_file in enumerate(
        ...
        try:
            ...
            # ------------------------------------------------
            # Failed file information in Excel
            # Only requested columns are used.
            # ------------------------------------------------
